...
static void errorEncounteredSAX (void *ctx, const char *msg, ...) {
    ...
    //MARK:(NSString *)msg→
	[parseResult addSAXError:[NSError errorWithDomain:@"SVG-SAX" code:1 userInfo:[NSDictionary dictionaryWithObjectsAndKeys:[ [NSString alloc] initWithUTF8String:msg], NSLocalizedDescriptionKey,
																				nil]]];
}
